...
import { Layout, BookOpen, Target, Zap, MessageSquare, BarChart3, Users, Layers, Library } from 'lucide-react';
...
export const MODULES: Module[] = [
  // Foundation
  { id: 'm1', title: 'What is a Product?', description: 'Physical vs Digital, B2B vs B2C basics.', difficulty: Difficulty.BEGINNER, category: 'Foundation', duration: '10m', locked: false },
  { id: 'm2', title: 'The Product Specialist Role', description: 'Day in the life and core responsibilities.', difficulty: Difficulty.BEGINNER, category: 'Foundation', duration: '15m', locked: false },
  { id: 'm3', title: 'Business Model Basics', description: 'How products actually make money.', difficulty: Difficulty.BEGINNER, category: 'Foundation', duration: '20m', locked: false },
  { id: 'm4', title: 'Tech for Non-Techies', description: 'APIs, Databases, and Frontends explained.', difficulty: Difficulty.BEGINNER, category: 'Foundation', duration: '25m', locked: false },
  
  // Core
  { id: 'm5', title: 'User Research 101', description: 'Running interviews without bias.', difficulty: Difficulty.INTERMEDIATE, category: 'Core', duration: '30m', locked: true },
  { id: 'm6', title: 'Writing User Stories', description: 'The "As a... I want to... So that..." format.', difficulty: Difficulty.INTERMEDIATE, category: 'Core', duration: '20m', locked: true },
  { id: 'm7', title: 'Prioritization Frameworks', description: 'RICE, MoSCoW, and saying No.', difficulty: Difficulty.INTERMEDIATE, category: 'Core', duration: '35m', locked: true },
  
  // Advanced
  { id: 'm8', title: 'Product Strategy', description: 'Vision vs. Strategy vs. Roadmap.', difficulty: Difficulty.ADVANCED, category: 'Advanced', duration: '45m', locked: true },
  { id: 'm9', title: 'Growth Mechanics', description: 'Loops, funnels, and viral coefficients.', difficulty: Difficulty.ADVANCED, category: 'Advanced', duration: '40m', locked: true },
];
