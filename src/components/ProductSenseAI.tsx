          ...
          {loading && (
            <div className="flex justify-start animate-fade-in">
              <div className="flex gap-3 max-w-[80%]">
                 <div className="w-10 h-10 shrink-0 border-2 border-black flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] bg-[#a3e635] text-black">
                    <Bot size={20} />
                 </div>
                 <div className="border-2 border-black p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)] bg-white flex items-center gap-2 min-w-[120px]">
                     <div className="w-2.5 h-2.5 bg-black rounded-full animate-bounce delay-0"></div>
                     <div className="w-2.5 h-2.5 bg-black rounded-full animate-bounce delay-150"></div>
                     <div className="w-2.5 h-2.5 bg-black rounded-full animate-bounce delay-300"></div>
