...
export const PracticeGround: React.FC = () => {
  ...
  const renderEvaluation = () => {
    ...
    return (
      <div className="animate-slide-up mt-6 scroll-mt-4" id="eval-result">
        <Card className={`border-2 ${evaluation.score > 75 ? 'border-green-500 bg-green-50' : evaluation.score > 50 ? 'border-yellow-500 bg-yellow-50' : 'border-red-500 bg-red-50'}`}>
            <div className="flex items-center justify-between mb-4 border-b border-black/10 pb-4">
                <div>
                    <h4 className="font-black uppercase text-xl">Analysis Report</h4>
                    <div className="text-xs uppercase font-bold text-gray-500">AI Mentor Feedback</div>
                </div>
                <div className="flex items-center gap-2">
                    <Award size={32} className={evaluation.score > 75 ? "text-green-600" : "text-gray-400"} />
                    <span className="text-4xl font-black">{evaluation.score}</span>
                </div>
            </div>
            
            <div className="mb-4">
                <p className="font-medium text-lg leading-relaxed whitespace-pre-wrap">{evaluation.feedback}</p>
            </div>
    ...
    return (
      <div className="max-w-7xl mx-auto pb-20 animate-fade-in">
        <div className="mb-12 text-center">
            <h2 className="text-6xl font-black uppercase tracking-tighter mb-4">Training Ground</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">Deliberate practice for product mastery. Choose a dojo to begin.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
            {/* CARD 1: User Stories */}
            <div onClick={() => setActiveDrill('STORY')} className="group cursor-pointer">
                <div className="bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] h-full p-8 hover:-translate-y-2 transition-transform flex flex-col relative overflow-hidden">
  ...
  return (
    <div className="max-w-5xl mx-auto pb-20 animate-fade-in">
        <Button variant="outline" onClick={reset} className="mb-6 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                        ...
                        {activeDrill === 'STORY' && (
                            <div className="space-y-6 animate-fade-in">
                                ...
                                <div className="relative">
                                    ...
                                    <input 
                                        className={`w-full border-2 p-4 font-medium focus:ring-4 focus:outline-none transition-all ${storyPersona ? 'border-black bg-white' : 'border-gray-300 bg-gray-50'}`}
                                ...
                                <div className="relative">
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-center gap-2">
                                        <span className="font-black text-gray-300 text-lg select-none md:w-24 md:text-right uppercase">I want to</span>
                                        <input 
                                            className={`w-full border-2 p-4 font-medium focus:ring-4 focus:outline-none transition-all ${storyAction ? 'border-black bg-white' : 'border-gray-300 bg-gray-50'}`}
                                ...
                                <div className="relative">
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-center gap-2">
                                        <span className="font-black text-gray-300 text-lg select-none md:w-24 md:text-right uppercase">So that</span>
                                        <input 
                                            className={`w-full border-2 p-4 font-medium focus:ring-4 focus:outline-none transition-all ${storyBenefit ? 'border-black bg-white' : 'border-gray-300 bg-gray-50'}`}
                                ...
                                <div className="bg-gray-900 text-white p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,0.2)] mt-6 relative overflow-hidden group">
                                    ...
                                    <p className="font-serif text-xl md:text-2xl leading-relaxed relative z-10">
                        ...
                        {activeDrill === 'METRIC' && (
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea 
                                        className="w-full border-2 border-black p-3 font-medium focus:ring-4 focus:ring-red-200 focus:outline-none h-32 resize-none"
                                ...
                                {researchMode === 'DESIGN' && (
                                    <div className="animate-fade-in">
                                        <div className="bg-green-50 border-2 border-black p-4 mb-6">
                                            ...
                                            <p className="font-bold text-lg">{researchMystery}</p>
                                        </div>
                                        <div className="mb-4">
                                        ...
                                        <div>
                                            ...
                                            <textarea 
                                                className="w-full border-2 border-black p-3 font-medium focus:ring-4 focus:ring-green-200 focus:outline-none h-40 resize-none"
                                ...
                                {researchMode === 'SCRIPTING' && (
                                    <div className="animate-fade-in">
                                        <div className="bg-blue-50 border-2 border-black p-4 mb-6 relative">
                                            ...
                                            {scriptScenario ? (
                                                <p className="font-bold text-lg">{scriptScenario}</p>
                                            ) : (
                                        ...
                                        <div>
                                            ...
                                            <textarea 
                                                className="w-full border-2 border-black p-3 font-medium focus:ring-4 focus:ring-blue-200 focus:outline-none h-40 resize-none"
                                ...
                                {researchMode === 'SYNTHESIS' && (
                                    <div className="animate-fade-in">
                                        ...
                                        <div>
                                            ...
                                            <textarea 
                                                className="w-full border-2 border-black p-3 font-medium focus:ring-4 focus:ring-yellow-200 focus:outline-none h-32 resize-none"
            ...
            <div className="md:col-span-5 space-y-6">
                {activeDrill === 'STORY' && (
                    <Card title="The INVEST Framework" className="bg-blue-50 border-blue-900 sticky top-4">
                        <ul className="space-y-3">
                            <li className="flex gap-3"><div className="font-black bg-blue-200 w-6 h-6 flex items-center justify-center rounded-full text-xs border border-black shadow-sm">I</div> <div className="text-sm"><strong>Independent:</strong> Can be released alone.</div></li>
                            <li className="flex gap-3"><div className="font-black bg-blue-200 w-6 h-6 flex items-center justify-center rounded-full text-xs border border-black shadow-sm">N</div> <div className="text-sm"><strong>Negotiable:</strong> Open to discussion.</div></li>
                            <li className="flex gap-3"><div className="font-black bg-blue-200 w-6 h-6 flex items-center justify-center rounded-full text-xs border border-black shadow-sm">V</div> <div className="text-sm"><strong>Valuable:</strong> Delivers value to user.</div></li>
                            <li className="flex gap-3"><div className="font-black bg-blue-200 w-6 h-6 flex items-center justify-center rounded-full text-xs border border-black shadow-sm">E</div> <div className="text-sm"><strong>Estimable:</strong> Devs can size it.</div></li>
                            <li className="flex gap-3"><div className="font-black bg-blue-200 w-6 h-6 flex items-center justify-center rounded-full text-xs border border-black shadow-sm">S</div> <div className="text-sm"><strong>Small:</strong> Fits in a sprint.</div></li>
                            <li className="flex gap-3"><div className="font-black bg-blue-200 w-6 h-6 flex items-center justify-center rounded-full text-xs border border-black shadow-sm">T</div> <div className="text-sm"><strong>Testable:</strong> QA can verify it.</div></li>
                        </ul>
                    </Card>
                )}
                {activeDrill === 'METRIC' && (
                    <Card title="Metric Rules" className="bg-red-50 border-red-900 sticky top-4">
                ...
                {activeDrill === 'PRD' && (
                    <Card title="PRD Best Practices" className="bg-purple-50 border-purple-900 sticky top-4">
                        <div className="space-y-4 text-sm">
                ...
                {activeDrill === 'RESEARCH' && (
                    <Card title="Research Cheat Sheet" className="bg-green-50 border-green-900 sticky top-4">
                        <div className="space-y-4 text-sm">
                            <div>
